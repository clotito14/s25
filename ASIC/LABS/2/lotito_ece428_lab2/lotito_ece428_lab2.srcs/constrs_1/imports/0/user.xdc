...
set_property IOSTANDARD LVCMOS33 [get_ports on_off_i]
...
set_property IOSTANDARD LVCMOS33 [get_ports low_battery_i]

set_property PACKAGE_PIN W17 [get_ports low_power_mode_i]

set_property IOSTANDARD LVCMOS33 [get_ports low_power_mode_i]
...
set_property IOSTANDARD LVCMOS33 [get_ports ready_o]

set_property PACKAGE_PIN N3 [get_ports reg_1v2_enable_o]

set_property IOSTANDARD LVCMOS33 [get_ports reg_1v2_enable_o]

set_property PACKAGE_PIN P1 [get_ports reg_2v5_enable_o]

set_property IOSTANDARD LVCMOS33 [get_ports reg_2v5_enable_o]

set_property PACKAGE_PIN L1 [get_ports reg_3v3_enable_o]

set_property IOSTANDARD LVCMOS33 [get_ports reg_3v3_enable_o]
